...
public class HarekDataMaker {
    ...
    public String[] aggregateAll(String[] names, int[] ages, String[] planets) {
        String firstEl = aggregateSingle(names[0], String.valueOf(ages[0]), planets[0]);
        String secondEl = aggregateSingle(names[1], String.valueOf(ages[1]), planets[1]);
        String thirdEl = aggregateSingle(names[2], String.valueOf(ages[2]), planets[2]);
        String[] aggregateArray = new String[] {firstEl, secondEl, thirdEl};
